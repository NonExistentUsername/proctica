...
"")
        ...
        self.pushButton.setGeometry(QtCore.QRect(50, 260, 101, 21))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        font.setWeight(50)
...
"border-radius:30;")
        ...
        self.var_name = QtWidgets.QLabel(Form)
        self.var_name.setGeometry(QtCore.QRect(10, 50, 171, 16))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(11)
        self.var_name.setFont(font)
        self.var_name.setStyleSheet("color:white;\n"
"")
